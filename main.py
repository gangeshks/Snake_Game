...
class SNAKE:
    def __init__(self):
        ...
        self.crunch_sound = pygame.mixer.Sound('./ra.wav')      
...
class MAIN:
    ...
    def draw_score(self):
        ...
        apple_rect = apple.get_rect(midright = (score_x - 10,score_y))
        bg_rect = pygame.Rect(apple_rect.left-2,apple_rect.top , apple_rect.width + score_rect.width + 16,apple_rect.height)
...
apple = pygame.image.load('abc.png').convert_alpha()
game_font = pygame.font.Font('angrybirds-regular.ttf', 25)
...
while True:
    ...
    screen.fill((175,215,70))                       # screen surface colour R-200  G-0   B-70
